        ...
        <Container style={{marginTop:"10px"}}>
            <Form>
                <Form.Group className="mb-3">
                    <Form.Label>Condidate 1 Name : </Form.Label>
                    <Form.Control ref={candidateName1} placeholder="Enter Condidate Name"></Form.Control>
                </Form.Group>
                <Form.Group className="mb-3">
                    <Form.Label>Condidate 1 Image URL : </Form.Label>
                    <Form.Control ref={candidateName1URL} placeholder="Enter Image URL"></Form.Control>
                </Form.Group>

                <Form.Group className="mb-3">
                    <Form.Label>Condidate 2 Name : </Form.Label>
                    <Form.Control ref={candidateName2} placeholder="Enter Condidate Name"></Form.Control>
                </Form.Group>
                <Form.Group className="mb-3">
                    <Form.Label>Condidate 2 Image URL : </Form.Label>
